...
-- select * from doctor
insert into doctor(first_name, last_name, specialization, email, phone_number, per_visit_cost, active_flag, login_id)
values ( 'Dr.Kefaya','Ghouri','Pediatricians','Kefaya.Ghouri@tansyacademy.com', '123433567890', 100, '0', 'dr_kefaya'),
		( 'Dr.Farheen', 'sultana', 'Gynecologists', 'Farheen.sultana@tansyacademy.com', '12345673234891', 80, '0', 'dr_farheen'),
		( 'Dr.Uzma','Sheikh','Orthopedic','Uzma.Sheikh@tansyacademy.com', '123433324567890', 90, '0', 'dr_uzma'),
		( 'Dr.Arsheen', 'Fatima', 'ENT specialists', 'Arsheen.Fatima@tansyacademy.com', '1234324355673234891', 69, '0', 'dr_arsheen'),
		('Dupont', 'Alice', 'Cardiologie', 'alice.dupont@example.com', '0712345678', 50, '0', 'alice_dupont'),  
		('Martin', 'Bob', 'Neurologie', 'bob.martin@example.com', '0723456789', 60, '0', 'bob_martin'),  
		('Thomas', 'David', 'Dermatologie', 'david.thomas@example.com', '0745678901', 55, '0', 'david_thomas'),  
		('Petit', 'Emma', 'Ophtalmologie', 'emma.petit@example.com', '0756789012', 65, '1', 'emma_petit'),  
		('Durand', 'Henry', 'Radiologie', 'henry.durand@example.com', '0789012345', 80, '0', 'henry_durand'),  
		('Moreau', 'Isla', 'Oncologie', 'isla.moreau@example.com', '0790123456', 90, '1', 'isla_moreau'),  
		('Simon', 'Jack', 'Medecine Generale', 'jack.simon@example.com', '0701234567', 40, '0', 'jack_simon')
;  
...
-- select * from nurse;
insert into nurse(first_name, last_name, email, phone_number, hire_date, active_flag, login_id)
values 	('Emily', 'Smith', 'emily.smith@example.com', '555-1234', '2025-08-16', '1', 'emily_smith'),  
		('Michael', 'Johnson', 'michael.johnson@example.com', '555-5678','2025-07-16', '1', 'michael_johnson'),  
		('Sophia', 'Williams', 'sophia.williams@example.com', '555-9101', '2025-06-16', '1', 'sophia_williams'),  
		('Daniel', 'Brown', 'daniel.brown@example.com', '555-1122', '2025-05-16', '0', 'daniel_brown'),  
		('Olivia', 'Jones', 'olivia.jones@example.com', '555-3344', '2025-04-16', '1', 'olivia_jones'),  
		('James', 'Garcia', 'james.garcia@example.com', '555-5566', '2025-03-16', '1', 'james_garcia'),  
		('Isabella', 'Martinez', 'isabella.martinez@example.com', '555-7788', '2025-02-16', '0', 'isabella_martinez'),  
		('William', 'Davis', 'william.davis@example.com', '555-9900', '2025-01-16', '1', 'william_davis'),  
		('Mia', 'Rodriguez', 'mia.rodriguez@example.com', '555-2233', '2024-02-16', '1', 'mia_rodriguez'),  
		('Benjamin', 'Lopez', 'benjamin.lopez@example.com', '555-4455', '2024-03-16', '0', 'benjamin_lopez')
;  
...
values ('Patient', 'Fracture treatment', '2025-02-01', '2025-02-10', 1),
		('Out Patient', 'Knee surgery', '2025-02-05', '2025-02-15', 2),
		('Patient', 'Heart attack treatment', '2025-02-02', '2025-02-12', 3),
		('Out Patient', 'Appendectomy', '2025-02-03', '2025-02-13', 4),
		('Patient', 'Stroke treatment', '2025-02-04', '2025-02-14', 5),
		('Out Patient', 'Hip replacement', '2025-02-06', '2025-02-16', 6),
		('Patient', 'Severe allergic reaction', '2025-02-07', '2025-02-17', 7),
		('Out Patient', 'Cataract surgery', '2025-02-08', '2025-02-18', 8),
		('Patient', 'Burn treatment', '2025-02-09', '2025-02-19', 9),
		('Out Patient', 'Spinal surgery', '2025-02-10', '2025-02-20', 10)
;

-- select * from appointment;
insert into appointment(appointment_date, status, patient_id, doctor_id, room_id, incharge_nurse_id, admission_id)
...
values
		...
		('2025-02-05', 'Appointment', 'Consultation and medications', 1500.00, 500.00, 2),
		...
		('2025-02-07', 'Appointment', 'Check-up and medication', 500.00, 100.00, 7),
		...
		('2025-02-10', 'Medicine', 'Meals during stay', 700.00, 150.00, 10)
;

-- select * from PAYMENT
insert into PAYMENT(billing_id, patient_id, amount_paid, payment_date)
...
values ('user1',  SHA2('password123', 256), '0'),
	('user2',  SHA2('mypassword456', 256), '0'),
	('user3',  SHA2('securepass789', 256), '0'),
	('user4',  SHA2('pass1234', 256), '0'),
	('user5',  SHA2('testpassword001', 256), '1'),
	('user6',  SHA2('adminpassword999', 256), '0'),
	('user7',  SHA2('password987', 256), '0'),
	('user8',  SHA2('userpass567', 256), '1'),
	('user9',  SHA2('welcome123', 256), '0'),
	('user10',  SHA2('strongpassword852', 256), '0')
;

-- select * from audit_log;
insert into audit_log(log_date, action ,user_type, user_id)
values
		('2025-02-01', 'Login', 'doctor', 1),
		('2025-02-02', 'Logout', 'doctor', 2),
		('2025-02-03', 'Login', 'doctor', 3),
		('2025-02-04', 'Logout', 'doctor', 4),
		('2025-02-05', 'Login', 'doctor', 5),
		('2025-02-06', 'Logout', 'doctor', 6),
		('2025-02-07', 'Login', 'doctor', 7),
		('2025-02-08', 'Logout', 'doctor', 8),
		('2025-02-09', 'Login', 'doctor', 9),
		('2025-02-10', 'Logout', 'doctor', 10),
        ('2025-02-01', 'Login', 'nurse', 1),
		('2025-02-02', 'Logout', 'nurse', 2),
		('2025-02-03', 'Login', 'nurse', 3),
		('2025-02-04', 'Logout', 'nurse', 4)
;
